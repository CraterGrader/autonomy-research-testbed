...
viper.SetDataPath(chrono.GetChronoDataPath() + 'robot/')

# Create Viper rover
driver = viper.ViperDCMotorControl()
rover = viper.Viper(system)
rover.SetDriver(driver)
rover.Initialize(chrono.ChFrameD(chrono.ChVectorD(
    0, -0.2, 0), chrono.ChQuaternionD(1, 0, 0, 0)))
...
vis.AddLightWithShadow(chrono.ChVectorD(1.5, -2.5, 5.5),
                       chrono.ChVectorD(0, 0, 0.5), 3, 4, 10, 40, 512)
